...
# Put the managed block first. OpenSSH generally uses the first value obtained,
# so this also takes precedence over ordinary settings in later Include files.
{
    printf '%s\n' "$BLOCK_BEGIN"
    printf '%s\n' \
